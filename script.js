...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      xipe_tagline: 'BUILD SOFTWARE THAT MOVES AT THE SPEED OF AI',
      xipe_desc: 'Xipe is our technology powerhouse. We design, validate, and build production-ready software systems by embedding AI into every step of the development process. From proof of concept to fully deployed products and dedicated engineering teams, we help companies move from vision to working software with speed and confidence.',
      xipe_cta: 'See how Xipe delivers',
      diana_tagline: 'THE FUTURE OF DEVELOPMENT, AUTOMATED.',
      diana_desc: 'Diana is our AI system designed to redefine how software is built. It enables the creation of production-ready code and build architectures in a fraction of the time.',
    ...
    es: {
      ...
      xipe_tagline: 'SOFTWARE QUE SE MUEVE A LA VELOCIDAD DE LA IA',
      xipe_desc: 'Xipe es nuestra potencia tecnológica. Diseñamos, validamos y construimos sistemas de software listos para producción integrando IA en cada paso del desarrollo. Desde pruebas de concepto hasta productos desplegados y equipos de ingeniería dedicados, ayudamos a las empresas a pasar de la visión al software funcional con velocidad y confianza.',
      xipe_cta: 'Descubre cómo entrega Xipe',
      diana_tagline: 'EL FUTURO DEL DESARROLLO, AUTOMATIZADO.',
      diana_desc: 'Diana es nuestro sistema de IA diseñado para redefinir cómo se construye el software. Permite la creación de código listo para producción y arquitecturas en una fracción del tiempo.',
